...
export default [
  ...
  // ==================== 资源配置 ====================
  {
    ...
    routes: [
      {
        path: '/resources',
        component: './shared/AccessRedirect',
        hideInMenu: true,
      },
      {
        path: '/resources/cmdb',
  ...
  // ==================== 执行模块 ====================
  {
    ...
    routes: [
      ...
      },
      {
        ...
        access: 'canExecuteTask',
        label: '任务执行',
        desc: '任务即时执行',
        navIcon: 'thunderbolt',
        navAccess: 'canExecuteTask',
      },
      {
  ...
  // ==================== 待办审批 ====================
  {
    ...
    name: '待办审批',
    icon: 'carryOut',
    access: 'canViewPendingCenter',
    categoryId: 'pending',
    categoryLabel: '待办审批',
    routes: [
      {
        path: '/pending',
        component: './pending-center/Redirect',
        hideInMenu: true,
      },
      {
  ...
  // ==================== 平台功能 (Platform Features) ====================
  {
    ...
    routes: [
      ...
      },
      {
        ...
        desc: '审批制租户数据访问',
        navIcon: 'eye',
        navAccess: 'canManagePlatformTenants',
      },
      {
