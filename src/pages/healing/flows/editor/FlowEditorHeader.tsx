  ...
  >
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      ...
      <Space size={6}>
        ...
        <Switch checked={autoCloseEnabled} onChange={onAutoCloseChange} />
        <Badge dot={autoCloseEnabled && !hasConfiguredCloseTemplate}>
          <Button
    ...
    <div style={{ display: 'flex', gap: 8 }}>
      ...
      <Button icon={<ClearOutlined />} onClick={onResetState}>
        重置状态
      </Button>
      <Button icon={<AppstoreOutlined />} onClick={onLayout}>
        一键整理
      </Button>
      <Button
        type="primary"
