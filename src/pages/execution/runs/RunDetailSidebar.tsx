...
const runtimeJsonPanelStyle: React.CSSProperties = {
  width: '100%',
  maxWidth: '100%',
    ...
    >
      <div className="industrial-dashed-box">
        ...
        <Field label="触发方式">
          <Tag
            icon={<UserOutlined />}
            color={triggeredBy.tagColor || triggeredBy.color}
            style={{ margin: 0 }}
          >
            {triggeredBy.label}
          </Tag>
      ...
      <div className="industrial-dashed-box">
        ...
        <Field label="通知">
          {hasEffectiveNotificationConfig(
            run?.task?.notification_config as never,
          ) ? (
            <Tag
              icon={<BellOutlined />}
              color="green"
      ...
      <div className="industrial-dashed-box">
        ...
        >
          <Statistic
            title="成功"
            value={stats.ok}
            styles={{ content: { color: '#52c41a', fontSize: 14 } }}
          />
          <Statistic
            title="变更"
            value={stats.changed}
            styles={{ content: { color: '#faad14', fontSize: 14 } }}
          />
          <Statistic
            title="失败"
            value={stats.failed}
          ...
          <Statistic
            ...
            styles={{ content: { color: '#cf1322', fontSize: 14 } }}
          />
        </div>
      </div>
    </div>
