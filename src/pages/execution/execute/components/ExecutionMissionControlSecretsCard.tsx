  ...
  return (
    ...
    >
      ...
      <span style={{ fontWeight: 500, marginRight: 4 }}>
        {secret ? secret.name : secretId.slice(0, 6)}
      </span>
      {secret && (
        <span
          style={{
...
const ExecutionMissionControlSecretsCard: React.FC<
  ExecutionMissionControlSecretsCardProps
> = ({
  additionalSecretIds,
  secretsSources,
  templateSecretIds,
  ...
  <div className="industrial-dashed-box" style={{ height: '100%' }}>
    <div className="industrial-dashed-box-title">
      <span>
        <SafetyCertificateOutlined /> 安全凭证 (Secrets)
      </span>
