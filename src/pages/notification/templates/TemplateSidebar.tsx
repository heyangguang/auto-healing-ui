  ...
  <div className="templates-sidebar" style={{ width, minWidth: width }}>
    ...
    >
      {loading ? (
        ...
        <>
          <div>
            {templates.map((template) => {
              const typeConfig = getTemplateEventTypeConfig(
                template.event_type || '',
              );
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Badge
                      status={template.is_active ? 'processing' : 'default'}
                    />
                  </div>
                  <div
                  ...
                  >
                    {typeConfig.icon && (
                      <span style={{ color: typeConfig.color, fontSize: 12 }}>
                        {typeConfig.icon}
                      </span>
                    )}
                    <Tag
        ...
        <div className="templates-sidebar-empty">
          <Empty
            description="暂无匹配的模板"
