...
export const OPERATIONS_WIDGET_REGISTRY: Record<string, WidgetDefinition> = {
  ...
  'list-plugin-syncs': {
    ...
    defaultLayout: { w: 6, h: 5, minW: 4, minH: 4 },
    component: (props: WidgetComponentProps) => <DashboardListWidget section="plugins" field="recent_syncs" title="最近同步记录" icon={<SyncOutlined />} {...props} />,
  },
  'list-plugin-errors': {
    id: 'list-plugin-errors', name: '异常插件列表', description: '当前异常状态的插件',
    category: 'list', section: 'plugins', icon: <BugOutlined />,
    defaultLayout: { w: 6, h: 5, minW: 4, minH: 4 },
    component: (props: WidgetComponentProps) => <DashboardListWidget section="plugins" field="error_plugins" title="异常插件列表" icon={<BugOutlined />} {...props} />,
  },
  'status-plugins': {
  ...
  'list-notif-failed': {
    ...
    defaultLayout: { w: 6, h: 5, minW: 4, minH: 4 },
    component: (props: WidgetComponentProps) => <DashboardListWidget section="notifications" field="failed_logs" title="失败通知列表" icon={<WarningOutlined />} {...props} />,
  },
  'stat-git-repos': {
  ...
  'list-git-repos': {
    ...
    defaultLayout: { w: 6, h: 5, minW: 4, minH: 4 },
    component: (props: WidgetComponentProps) => <DashboardListWidget section="git" field="repos" title="仓库列表" icon={<BranchesOutlined />} {...props} />,
  },
  'list-git-syncs': {
    id: 'list-git-syncs', name: '最近同步', description: '最近的 Git 同步记录',
    category: 'list', section: 'git', icon: <SyncOutlined />,
    defaultLayout: { w: 6, h: 5, minW: 4, minH: 4 },
    component: (props: WidgetComponentProps) => <DashboardListWidget section="git" field="recent_syncs" title="最近同步" icon={<SyncOutlined />} {...props} />,
  },
  'stat-playbooks': {
  ...
  'list-playbook-scans': {
    ...
    defaultLayout: { w: 6, h: 5, minW: 4, minH: 4 },
    component: (props: WidgetComponentProps) => <DashboardListWidget section="playbooks" field="recent_scans" title="最近扫描记录" icon={<FileTextOutlined />} {...props} />,
  },
  'stat-secrets': {
  ...
  'list-recent-logins': {
    ...
    defaultLayout: { w: 6, h: 5, minW: 4, minH: 4 },
    component: (props: WidgetComponentProps) => <DashboardListWidget section="users" field="recent_logins" title="最近登录" icon={<TeamOutlined />} {...props} />,
  },
