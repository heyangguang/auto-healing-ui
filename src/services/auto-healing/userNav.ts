...
export async function getFavorites() {
    return unwrapData(await request<{ code: number; message: string; data: FavoriteItem[] }>(
...
export async function getRecents() {
    return unwrapData(await request<{ code: number; message: string; data: RecentItem[] }>(
